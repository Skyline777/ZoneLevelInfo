...
if (currentLocale == "esES" or currentLocale == "esMX") then
	...
	zones = {
			...
			,["Isla de los MJ"] = {0,0,"H"}
			,["Ciudad de Lunargenta"] = {0,0,"A"}
			,["Ciudad de Ventormenta"] = {0,80,"S"}
			,["Entrañas"] = {0,0,"A"}
			,["Forjaz"] = {0,0,"A"}
			,["Tranvía Subterráneo"] = {0,0,"A"}
			,["Cima del Trueno"] = {0,80,"S"}
			,["Darnassus"] = {0,80,"S"}
			,["El Exodar"] = {0,0,"A"}
			,["Orgrimmar"] = {0,80,"S"}
	...
	zones = {
			...
			,["Stormwind City"] = {0,80,"S"}
			,["Undercity"] = {0,0,"A"}
			,["Darnassus"] = {0,80,"S"}
			,["Orgrimmar"] = {0,80,"S"}
			,["The Exodar"] = {0,0,"A"}
			,["Thunder Bluff"] = {0,80,"S"}
			...
			,["Stonetalon Mountains"] = {35,40,"N"}
			,["Duskwood"] = {0,0,"A"}
			,["Ashenvale"] = {18,30,"L"}
			,["Hillsbrad Foothills"] = {0,0,"A"}
			,["Wetlands"] = {0,0,"A"}
			,["Thousand Needles"] = {0,0,"A"}
			,["Alterac Mountains"] = {0,0,"A"}
			,["Arathi Highlands"] = {0,0,"A"}
			,["Desolace"] = {35,40,"N"}
			,["Stranglethorn Vale"] = {0,0,"A"}
			,["Badlands"] = {0,0,"A"}
