...
if (currentLocale == "esES" or currentLocale == "esMX") then
	...
	if (playerFaction[1] == "Alliance") then
		zones = {
		...
		zones = {
				...
				,["Isla de los MJ"] = {0,0,"N"}
				,["Ciudad de Lunargenta"] = {0,0,"A"}
				,["Ciudad de Ventormenta"] = {0,80,"N"}
				,["Entrañas"] = {0,80,"C"}
				,["Forjaz"] = {0,80,"N"}
				,["Tranvía Subterráneo"] = {0,80,"N"}
	...
	if (playerFaction[1] == "Alliance") then
		zones = {
				...
				,["Stormwind City"] = {0,80,"N"}
				,["Undercity"] = {0,80,"N"}
				,["Darnassus"] = {0,80,"C"}
				,["Orgrimmar"] = {0,80,"N"}
				,["The Exodar"] = {0,0,"A"}
				,["Thunder Bluff"] = {0,80,"N"}
				,["Shattrath City"] = {0,0,"A"}
				,["Dalaran"] = {0,0,"A"}
				,["Dun Morogh"] = {1,10,"H"}
				,["Elwynn Forest"] = {1,10,"H"}
				,["Eversong Woods"] = {0,0,"A"}
				,["Tirisfal Glades"] = {1,10,"N"}
